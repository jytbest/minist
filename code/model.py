...
#  usage: python model.py --output ./modelFiles --data_path ./data/test
def parse_args():
...
def load_data(args) :
    dataset = preprocessing.image_dataset_from_directory(
        args.data_path, batch_size=BATCH_SIZE, image_size=(28, 28))
...
def train():
    ...
    # Checkpoint是模型的权重
    checkpoint = ModelCheckpoint(args.output+"/mnist_model.hdf5", monitor='val_loss', verbose=1,
    ...
    model.save(args.output+"/mnist_model.h5", save_format='tf')
